...
public class Solution {
    ...
    public static class Violin implements MusicalInstrument, Runnable {
        ...
        @Override
        public void run() {
            long res = startPlaying().getTime();
            sleepNSeconds(1);
            long res1 = stopPlaying().getTime();
            long res2 = res1-res;
            System.out.println("Playing " + res2  + " ms");
        }
    }
}
